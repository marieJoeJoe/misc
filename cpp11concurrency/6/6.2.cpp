...
/*
std::string params_cut="params/mh100/MH100-F7D34A97/cut";
std::string params_area_remove="params/mh100/MH100-F7D34A97/area/remove";
std::string params_area_list="params/mh100/MH100-F7D34A97/area/list";
std::string params_speed="params/mh100/MH100-F7D34A97/speed";
std::string control_device="control/mh100/MH100-F7D34A97/device";
std::string params_area_add="params/mh100/MH100-F7D34A97/area/add";
std::string update_check_progress="update/mh100/MH100-F7D34A97/progress";
std::string update_check_check="update/mh100/MH100-F7D34A97/check";
std::string status ="/status/mh100/MH100-F7D34A97/device";
*/
...
void mqtt_to_mcu_topic(std::string& mqtt_topic){
  ...
  mqtt_topic.erase(iter,device_sn.begin(),device_sn.end());
}
